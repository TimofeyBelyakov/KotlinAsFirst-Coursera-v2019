...
class Tests {
    ...
    fun accountInThreeYears() {
        assertEquals(133.1, accountInThreeYears(100.0, 10.0), 1e-2)
        assertEquals(1.0, accountInThreeYears(1.0, 0.0), 1e-2)
        assertEquals(104.0, accountInThreeYears(13.0, 100.0), 1e-2)
    }
